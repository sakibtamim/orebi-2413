      ...
      <Container>
        <div className="flex  items-center lg:gap-0 gap-y-5">
          <div className="lg:w-1/4 w-1/6 relative">
            ...
            {cateShow && (
              <div className=" lg:w-[250px] w-[160px] absolute lg:top-[28px] top-[47px] left-0  ">
          ...
          <div className="lg:w-1/4 w-2/6">
            <div className="flex justify-end lg:gap-x-[40px] gap-x-[10px]">
              ...
              >
                ...
                {accountShow && (
                  <div className="lg:w-[200px] w-[150px] absolute lg:top-[28px] top-[47px] right-0  transition-all duration-300 ease-in-out origin-top-right">
              ...
              <div className="relative" ref={cartRef}>
                ...
                {cartShow && (
                  <div className="absolute lg:top-[28px] right-0 top-[47px] lg:w-[360px] w-[240px] bg-white border-[#F0F0F0] border-[1px]">
